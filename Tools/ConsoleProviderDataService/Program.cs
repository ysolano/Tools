namespace ConsoleProviderDataService
{
    using System;
    using System.Collections.Generic;
    using System.Data;
    using Models;
    using ProviderDataService;

    class Program
    {
        static void Main(string[] args)
        {
            /*URL: http://www.csharpdocs.com/generic-data-access-layer-in-c-using-dbproviderfactories/ */
            /* https://www.youtube.com/watch?v=DiYppDWrKDk */

            Console.WriteLine("================ Using Microsoft Provider Factory =================\n\n\n");
